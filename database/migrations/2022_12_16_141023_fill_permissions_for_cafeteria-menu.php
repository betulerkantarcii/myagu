...
class FillPermissionsForCafeteriaMenu extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCafeteriaMenu constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cafeteria-menu',
            'admin.cafeteria-menu.index',
            'admin.cafeteria-menu.create',
            'admin.cafeteria-menu.show',
            'admin.cafeteria-menu.edit',
            'admin.cafeteria-menu.delete',
            'admin.cafeteria-menu.bulk-delete',
        ]);

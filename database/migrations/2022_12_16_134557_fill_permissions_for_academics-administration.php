...
class FillPermissionsForAcademicsAdministration extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAcademicsAdministration constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.academics-administration',
            'admin.academics-administration.index',
            'admin.academics-administration.create',
            'admin.academics-administration.show',
            'admin.academics-administration.edit',
            'admin.academics-administration.delete',
            'admin.academics-administration.bulk-delete',
        ]);

...
class FillPermissionsForCommunicate extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCommunicate constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.communicate',
            'admin.communicate.index',
            'admin.communicate.create',
            'admin.communicate.show',
            'admin.communicate.edit',
            'admin.communicate.delete',
            'admin.communicate.bulk-delete',
        ]);

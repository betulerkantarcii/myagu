...
class FillPermissionsForManageCourse extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForManageCourse constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.manage-course',
            'admin.manage-course.index',
            'admin.manage-course.create',
            'admin.manage-course.show',
            'admin.manage-course.edit',
            'admin.manage-course.delete',
            'admin.manage-course.bulk-delete',
        ]);
